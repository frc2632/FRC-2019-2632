...
public class RobotMap{
    ...
    public static double SAFE_ELEVATOR_HEIGHT = 10;
    ...
    public static final int FRONT_LIFT_MOTOR = 2;
    public static final int MID_LIFT_MOTOR = 1;
    public static final int BACK_LIFT_MOTOR = 0;
    public static final int LIFT_WHEEL_MOTOR = 3;


    //NOT CAN
    public static final int HATCH_LIMITSWITCH = 0;
    public static final int LIFT_CONFIG_LIMITSWITCH = 1;
